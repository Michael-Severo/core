...
4. **System Events Handling**: System events (those with names starting with `system:`) are still forwarded to wildcard subscribers, allowing for complete system monitoring.
